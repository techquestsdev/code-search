...
func TestExtractRepoNameFromShard(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			shardName: "gitlab.example.net%2Fapps%2Fexample%2Fexample-project_v16.00000.zoekt",
			expected:  "gitlab.example.net%2Fapps%2Fexample%2Fexample-project",
		},
		{
			name:      "URL-encoded simple path",
			shardName: "gitlab.example.net%2Futils%2Fgoogle-pso-code_v16.00000.zoekt",
			expected:  "gitlab.example.net%2Futils%2Fgoogle-pso-code",
		},
		{
