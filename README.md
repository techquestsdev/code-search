...
The Enterprise Edition is currently in **open alpha** — free to use while in early access, no pricing, no commitment. Request a license via the [contact page](https://code-search.techquests.dev/contact/) to get started.
...
**[Learn more about Enterprise →](https://code-search.techquests.dev/enterprise/overview/)**
