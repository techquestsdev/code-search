...
ALTER TABLE repositories ADD COLUMN excluded BOOLEAN NOT NULL DEFAULT FALSE;

-- Index for efficient filtering
CREATE INDEX idx_repositories_excluded ON repositories(excluded);
